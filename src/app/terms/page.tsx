      ...
      <section className="pt-32 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-card p-6 sm:p-10 rounded-3xl border border-white/10 space-y-8 text-sm text-[var(--color-text-secondary)] leading-relaxed shadow-2xl">
          ...
          <div className="space-y-3 pb-6 border-b border-white/10">
            <p>
              Welcome to the official portal of <strong>Lilhawkers Sports Management Private Limited</strong> (&quot;Lilhawkers&quot;, &quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). These Terms and Conditions (&quot;Terms&quot;) constitute a legally binding agreement between you—whether individually or as an authorized representative of a school, educational institution, sports club, training academy, or community body (&quot;Partner&quot;, &quot;Client&quot;, &quot;Institution&quot;, or &quot;User&quot;)—and Lilhawkers Sports Management Pvt. Ltd.
            </p>
            <p>
              By accessing our website (<a href="https://lilhawkers.com" className="text-[var(--color-primary)] hover:underline">https://lilhawkers.com</a>), requesting a demonstration curriculum session, or engaging in any institutional collaboration, you acknowledge that you have read, understood, and agreed to be bound by these Terms.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li>
                <strong className="text-white">Scheduling &amp; Feasibility:</strong> Demonstration requests are subject to coach availability, institutional verification, and geographic feasibility. Submission of a form does not guarantee immediate scheduling.
              </li>
              <li>
                <strong className="text-white">Non-Binding Nature:</strong> A demonstration request or on-ground trial does not constitute a full service contract. Formal implementation requires the execution of a separate written Service Level Agreement (SLA) or Memorandum of Understanding (MOU) outlining commercial terms, scope, and duration.
              </li>
              <li>
                <strong className="text-white">Authority to Book:</strong> The individual submitting a demo request warrants that they have the requisite authority from their respective institution to invite Lilhawkers personnel onto the premises.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li>
                <strong className="text-white">Physical Suitability:</strong> The Partner Institution is responsible for ensuring that all participating students or athletes are physically fit to engage in structured sports activities and have cleared applicable internal medical checks.
              </li>
              <li>
                <strong className="text-white">Institutional Faculty Presence:</strong> Partner institutions must ensure that a designated teacher, sports coordinator, or authorized staff member is present during on-campus training sessions.
              </li>
              <li>
                <strong className="text-white">Safety Protocols:</strong> Lilhawkers instructors adhere strictly to age-appropriate progressive warmups, injury-prevention drills, and hydration intervals.
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-1.5">
              <li>
                <strong className="text-white">Curriculum Frameworks:</strong> The Six-Stage Development Matrix, 7-Step Delivery System, drill cards, and training manuals are protected under Indian Copyright and Trademark laws.
              </li>
              <li>
                <strong className="text-white">Prohibited Actions:</strong> Partner institutions and users may not copy, reverse-engineer, record, publish, distribute, or commercially exploit Lilhawkers pedagogical materials to third parties without prior written consent.
              </li>
              <li>
                <strong className="text-white">Trademarks:</strong> &quot;LILHAWKERS&quot;, the Lilhawkers emblem, and &quot;Learn &bull; Play &bull; Grow&quot; are proprietary trademarks of the Company.
              </li>
            </ul>
          </div>
